...
export async function GET(request, { params }) {
  try {
    ...
    return NextResponse.json({ comments: magazine.comments || [] });
  } catch (error) {
...
export async function DELETE(request, { params }) {
  try {
    ...
    const comment = magazine.comments?.find(c => c._id.toString() === commentId);
    ...
    if (comment.authorId.toString() !== decoded.userId && decoded.role !== 'admin') {
      return NextResponse.json(
