...
const MagazinePost = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Header Image */}
      <div className="relative h-[300px] md:h-[400px] lg:h-[500px] bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden">
        <img
          src={post.thumbnail}
          alt={post.title}
      ...
      {/* Article Content */}
      <article className="max-w-5xl mx-auto px-4 md:px-6 -mt-40 md:-mt-60 lg:-mt-80 relative z-10 pb-12 md:pb-20">
        {/* Back Button */}
        <button
          onClick={() => navigate('/magazine')}
          className="mb-4 md:mb-8 px-4 py-2 md:px-6 md:py-3 bg-white/10 backdrop-blur-md text-white hover:bg-white/20 transition-all duration-300 rounded-full flex items-center gap-2 border border-white/20 shadow-lg text-sm md:text-base"
        >
        ...
        <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          {/* Article Header */}
          <div className="p-6 md:p-10 lg:p-16 border-b border-gray-100 bg-gradient-to-b from-white to-gray-50/50">
            {/* Category Badge */}
            <div className="mb-4 md:mb-6">
              <span className="px-3 py-1.5 md:px-5 md:py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full font-semibold text-xs md:text-sm shadow-lg shadow-blue-500/30">
                {post.category}
              </span>
            </div>

            {/* Title */}
            <h1 className="text-2xl md:text-4xl lg:text-6xl font-extrabold text-gray-900 mb-4 md:mb-8 leading-tight">
              {post.title}
            </h1>

            {/* Meta Information */}
            <div className="flex flex-wrap items-center gap-2 md:gap-4 text-xs md:text-base text-gray-600 mb-4 md:mb-6">
